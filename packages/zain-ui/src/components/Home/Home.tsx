...
import MenuList, { MenuListItem } from 'src/components/MenuList';
...
export class Home extends Component {
    ...
    render(): JSX.Element {
        return (
            <div className="Zui-Home">
                <MenuList
                    menuListItems={this.getFileMenuListItem()}
                    onClickMenuListItem={(menuListItemReturn: MenuListItem) => { console.log('zain>>>>>menuListItemReturn', menuListItemReturn); }}
                >menuList</MenuList>
            </div>
        );
    }
